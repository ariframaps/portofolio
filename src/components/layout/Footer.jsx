...
export const Footer = () => {
    return (
        <footer className="px-8 xl:px-0 relative z-[2] h-60 lg:h-80 bg-slate-50">
            <div className="flex items-center max-w-xl m-auto h-full">
                <div className='flex flex-col lg:flex-row justify-between w-full'>
                    <div className='w-fit pb-4 border border-0 border-b-2 mb-4'>
                    ...
                    <div>
                        ...
                        <div className='font-lato mt-4 lg:mt-[30px] text-[#7D7D7D]'>
