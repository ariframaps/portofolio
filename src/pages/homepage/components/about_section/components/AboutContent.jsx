export const AboutContent = () => {
    return (
        <div className="flex flex-col text-lg gap-3 md:gap-4 text-[#717171] font-lato lg:pe-[20px] lg:border-box lg:border lg:border-0 lg:border-r-2 leading-7 md:leading-8">
