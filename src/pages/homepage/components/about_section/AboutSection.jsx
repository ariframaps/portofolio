            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center lg:items-start gap-[70px] max-w-screen-xl m-auto text-black dark:text-[#D8D8D8] ">
                <article>
                    <div className="sticky top-14 lg:max-w-xl">
                        ...
                        <AboutContent />
                        <a href="#" className="flex items-center gap-2 font-poppins block mt-7 bg-black text-white dark:text-slate-300 w-fit p-3 px-4 rounded-md border dark:border-slate-700 border-black hover:bg-transparent dark:hover:bg-slate-200 hover:text-black duration-200">
                            See full resume
