...
export const AboutSection = () => {
    return (
        <section id="about_section" className="px-2 md:px-8 xl:px-0 min-h-screen pt-[60px] md:pt-[90px] pb-[70px] lg:pt-[120px] lg:pb-[150px]">
            <div className="relative flex flex-col lg:flex-row justify-between items-center lg:items-start gap-[70px] max-w-screen-xl m-auto text-black dark:text-[#D8D8D8] ">
                <article>
                    <div className="sticky top-14 lg:max-w-xl">
                        ...
                        <AboutContent />
                        <a href="#" className="flex items-center gap-2 font-poppins block mt-7 bg-black text-white dark:text-slate-300 w-fit p-3 px-4 text-xs md:text-md rounded-md border dark:border-slate-700 border-black hover:bg-transparent dark:hover:bg-slate-200 hover:text-black duration-200">
                            See full resume
