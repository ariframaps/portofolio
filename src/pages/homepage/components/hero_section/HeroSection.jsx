...
export const HeroSection = () => {
    return (
        <section id='hero_section' className="bg-[url('../assets/background/hero_image-light.webp')] dark:bg-[url('../assets/background/hero_image-dark.webp')] relative z-[2] min-h-screen">
